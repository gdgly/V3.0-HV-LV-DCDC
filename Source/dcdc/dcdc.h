...
extern uint16_t dcdc_output_voltage_hw_over_voltage_counter_get(void);
extern uint16_t dcdc_output_voltage_sw_over_voltage_counter_get(void);
extern uint16_t dcdc_output_current_hw_over_current_counter_get(void);
extern uint16_t dcdc_output_current_sw_over_current_counter_get(void);
...
extern void dcdc_output_voltage_hw_over_voltage_counter_reset(void);
extern void dcdc_output_voltage_sw_over_voltage_counter_reset(void);
extern void dcdc_output_current_hw_over_current_counter_reset(void);
extern void dcdc_output_current_sw_over_current_counter_reset(void);
