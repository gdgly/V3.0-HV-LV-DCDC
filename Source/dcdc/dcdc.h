...
#define EPWM1_FREQ          70000UL
#define EPWM1_PERIOD        PWM_PERIOD_IN_COUNTS_UP_COUNTER(EPWM1_FREQ)
#define EPWM1_DEADBAND      10U // 100ns

#define EPWM2_FREQ          70000UL
#define EPWM2_PERIOD        PWM_PERIOD_IN_COUNTS_UP_COUNTER(EPWM2_FREQ)
#define EPWM2_DEADBAND      10U // 100ns

#define EPWM3_FREQ          70000UL
#define EPWM3_PERIOD        PWM_PERIOD_IN_COUNTS_UP_COUNTER(EPWM3_FREQ)

#define EPWM4_FREQ          50000UL // TODO
#define EPWM4_PERIOD        PWM_PERIOD_IN_COUNTS_UP_COUNTER(EPWM4_FREQ)
